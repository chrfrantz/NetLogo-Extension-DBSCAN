...
/**
 * Distance metric implementation for agent locations for vertical cylinder topology 
 * (x-wrapping enabled, y-wrapping disabled).
 * 
    ...
    public double calculateDistance(Agent val1, Agent val2) throws DBSCANClusteringException {
        ...
        try {
            ...
            throw new DBSCANClusteringException(e.getMessage() + "; Agent Coordinates: " +
                    ...
                    "World topology: vertical cylinder"
                    );
        }
    }
