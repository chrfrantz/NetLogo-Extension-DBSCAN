...
For variable-based clustering of patches (as opposed to individuals), patches are clustered based on resource level and the minimum number of members required to form a cluster.
